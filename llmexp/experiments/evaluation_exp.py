...
if __name__ == "__main__":
    ...
    for data in test_data:
        ...
        theta = explainer.thompson_sampling(sentences, question, response, n_iter=num_iter)
        ...
        results_df.to_csv(f'results/{model_name}_{dataset_name}_mab_niter_{num_iter}.csv', index=False)
